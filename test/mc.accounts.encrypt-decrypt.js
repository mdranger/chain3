var Accounts = require("./../packages/chain3-mc-accounts/src/index.js");
...
describe("mc", function () {
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            it("encrypt mc.account, and compare to ethers wallet", async () => {
            ...
            it("decrypt static signature using ethers wallet and eth.account and compare", async () => {
                ...
                // compare addresses
                assert.equal(acc.address, ethWall.address);
                assert.equal(chain3.utils.toChecksumAddress('0x143f8913e0417997304fc179b531ff4cb9cab582'), acc.address);
                assert.equal(chain3.utils.toChecksumAddress('0x143f8913e0417997304fc179b531ff4cb9cab582'), ethWall.address);
